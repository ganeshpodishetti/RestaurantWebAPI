...
namespace Restaurants.Tests.Infrastructure;
...
public class CreatedMultipleRestaurantsRequirementHandlerTests
    {
        ...
        public async Task HandleRequirementAsync_UserHasNotCreatedMultipleRestaurants_ShouldFail()
        {
            ...
            // };
            //
            // var restaurantsRepositoryMock = new Mock<IRestaurantsRepo>();
            // restaurantsRepositoryMock.Setup(r => r.GetAllRestaurantsAsync()).ReturnsAsync(restaurants);
            //
